...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var SLabel_1 = __webpack_require__(1);
	var STextField_1 = __webpack_require__(36);
	var FRP = (function () {
	    function FRP() {
	    }
	    FRP.main = function () {
	        var textA = new STextField_1.default("0");
	        var textB = new STextField_1.default("0");
	        var a = textA.text.map(function (s) { return parseInt(s); });
	        var b = textB.text.map(function (s) { return parseInt(s); });
	        var sum = a.lift(b, function (a_, b_) { return a_ + b_; });
	        var lblSum = new SLabel_1.default(sum.map(function (i) { return i.toString(); }));
	    };
	    return FRP;
	}());
	FRP.main();
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var sodiumjs_1 = __webpack_require__(2);
	var SLabel = (function () {
	    function SLabel(text) {
	        var _this = this;
	        this.l = sodiumjs_1.Operational.updates(text).listen(function (t) {
	            _this.setText(t);
	        });
	        this.label = document.createElement('h5');
	        this.render();
	    }
	    SLabel.prototype.setText = function (t) {
	        this.label.textContent = t;
	    };
	    SLabel.prototype.render = function () {
	        document.body.appendChild(this.label);
	    };
	    return SLabel;
	}());
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SLabel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var Lambda_1 = __webpack_require__(3);
	...
	var StreamSink_1 = __webpack_require__(28);
	exports.StreamSink = StreamSink_1.StreamSink;
	var Cell_1 = __webpack_require__(22);
	exports.Cell = Cell_1.Cell;
	var CellLoop_1 = __webpack_require__(29);
	exports.CellLoop = CellLoop_1.CellLoop;
	var CellSink_1 = __webpack_require__(30);
	exports.CellSink = CellSink_1.CellSink;
	var Transaction_1 = __webpack_require__(6);
	exports.Transaction = Transaction_1.Transaction;
	var Tuple2_1 = __webpack_require__(31);
	exports.Tuple2 = Tuple2_1.Tuple2;
	var Unit_1 = __webpack_require__(25);
	exports.Unit = Unit_1.Unit;
	var Operational_1 = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vertex_1 = __webpack_require__(4);
	var Transaction_1 = __webpack_require__(6);
	var CoalesceHandler_1 = __webpack_require__(21);
	var Cell_1 = __webpack_require__(22);
	//import { StreamLoop } from "./StreamLoop";
	var Listener_1 = __webpack_require__(26);
	var Lazy_1 = __webpack_require__(23);
	var LazyCell_1 = __webpack_require__(27);
	var Stream = (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var typescript_collections_1 = __webpack_require__(7);
	var Entry = (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	var _arrays = __webpack_require__(8);
	exports.arrays = _arrays;
	var Bag_1 = __webpack_require__(10);
	exports.Bag = Bag_1.default;
	var BSTree_1 = __webpack_require__(13);
	exports.BSTree = BSTree_1.default;
	var Dictionary_1 = __webpack_require__(11);
	exports.Dictionary = Dictionary_1.default;
	var Heap_1 = __webpack_require__(16);
	exports.Heap = Heap_1.default;
	var LinkedDictionary_1 = __webpack_require__(17);
	exports.LinkedDictionary = LinkedDictionary_1.default;
	var LinkedList_1 = __webpack_require__(15);
	exports.LinkedList = LinkedList_1.default;
	var MultiDictionary_1 = __webpack_require__(18);
	exports.MultiDictionary = MultiDictionary_1.default;
	var Queue_1 = __webpack_require__(14);
	exports.Queue = Queue_1.default;
	var PriorityQueue_1 = __webpack_require__(19);
	exports.PriorityQueue = PriorityQueue_1.default;
	var Set_1 = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextField = (function () {
	    function TextField(initText) {
	        var _this = this;
	        var sUserChangesSnk = new sodiumjs_1.StreamSink();
	        this.sUserChanges = sUserChangesSnk;
	        this.text = sUserChangesSnk
	            .filter(function (s) { return parseInt(s) === parseInt(s); })
	            .hold(initText);
	        this.input = document.createElement('input');
	        this.input.value = this.text.sample();
	        this.input.addEventListener('input', function (event) {
	            _this.text = _this.text.map(function () { return event.target.value; });
