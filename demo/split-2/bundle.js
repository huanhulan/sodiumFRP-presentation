...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var sodiumjs_1 = __webpack_require__(1);
	var FrpPromise = (function () {
	    function FrpPromise(sDeliver) {
	        var _this = this;
	        this.done = false;
	        this.sDeliver = sDeliver.once();
	        this.oValue = this.sDeliver.map(function (a) { return a; })
	            .hold(null);
	        this.sDeliver.listen(function () { return _this.done = true; });
	    }
	    FrpPromise.prototype.then = function () {
	        return sodiumjs_1.Operational.value(this.oValue).filterNotNull()
	            .orElse(this.sDeliver).once();
	    };
	    FrpPromise.prototype.thenDo = function (h) {
	        var _this = this;
	        sodiumjs_1.Transaction.run(function () { return _this.then().listen(h); });
	        return this;
	    };
	    return FrpPromise;
	}());
	var FRP = (function () {
	    ...
	    FRP.main = function () {
	        ...
	        // {
	        //     // split
	        //     Operational.updates(Operational.split(sAs).accum(0,(a,b)=>a+b))
	        //     .listen(total=>{
	        //         const $p = document.createElement('p');
	        ...
	        // sAs.send([1,5]);
	        //nested split
	        var sAss = new sodiumjs_1.StreamSink();
	        sodiumjs_1.Transaction.run(function () {
	            sodiumjs_1.Operational.updates(sodiumjs_1.Operational.split(sodiumjs_1.Operational.split(sAss))
	                .accum('', function (a, b) { return a + b; }))
	                .listen(function (total) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lambda_1 = __webpack_require__(2);
	...
	var Operational_1 = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vertex_1 = __webpack_require__(3);
	var Transaction_1 = __webpack_require__(5);
	var CoalesceHandler_1 = __webpack_require__(20);
	var Cell_1 = __webpack_require__(21);
	//import { StreamLoop } from "./StreamLoop";
	var Listener_1 = __webpack_require__(25);
	var Lazy_1 = __webpack_require__(22);
	var LazyCell_1 = __webpack_require__(26);
	var Stream = (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var typescript_collections_1 = __webpack_require__(6);
	var Entry = (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bag_1 = __webpack_require__(9);
	exports.Bag = Bag_1.default;
	var BSTree_1 = __webpack_require__(12);
	exports.BSTree = BSTree_1.default;
	var Dictionary_1 = __webpack_require__(10);
	exports.Dictionary = Dictionary_1.default;
	var Heap_1 = __webpack_require__(15);
	exports.Heap = Heap_1.default;
	var LinkedDictionary_1 = __webpack_require__(16);
	exports.LinkedDictionary = LinkedDictionary_1.default;
	var LinkedList_1 = __webpack_require__(14);
	exports.LinkedList = LinkedList_1.default;
	var MultiDictionary_1 = __webpack_require__(17);
	exports.MultiDictionary = MultiDictionary_1.default;
	var Queue_1 = __webpack_require__(13);
	exports.Queue = Queue_1.default;
	var PriorityQueue_1 = __webpack_require__(18);
