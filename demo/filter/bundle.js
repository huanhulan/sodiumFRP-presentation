...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var SButton_1 = __webpack_require__(1);
	var SLabel_1 = __webpack_require__(36);
	...
	var FRP = (function () {
	    ...
	    FRP.main = function () {
	        sodiumjs_1.Transaction.run(function () {
	            ...
	            var label = new SLabel_1.default(value.map(function (i) { return i.toString(); }));
	            var btnPlus = new SButton_1.default("+");
	            var btnMinus = new SButton_1.default("-");
	            var sDelta = btnPlus.sClicked.map(function (u) { return 1; })
	                .orElse(btnMinus.sClicked.map(function (u) { return -1; }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = (function () {
	    function Button(name) {
	        ...
	        this.sClickedSink = new sodiumjs_1.StreamSink();
	        this.sClicked = this.sClickedSink;
	        this.button.addEventListener('click', function (event) {
	            _this.sClickedSink.send(sodiumjs_1.Unit.UNIT);
	        });
	        this.render();
	    }
